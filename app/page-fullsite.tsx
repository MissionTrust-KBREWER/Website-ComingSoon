...
export default function Home() {
  ...
  const credentialChips = [
    ...
    "Principal Author & Lead Architect: DoW ZT Strategy | CISA ZTMM | CMMC | FedRAMP High Guidance",
    "Federal Civilian | DoW | Intelligence Community",
