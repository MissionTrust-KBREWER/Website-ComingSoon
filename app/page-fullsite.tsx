...
export default function Home() {
  ...
  const credentialChips = [
    ...
    "Lead Author: Microsoft Official Guidance on Zero Trust, Identity & Compliance",
    "Federal Civilian | DoW | Intelligence Community",
